...
cat(paste0(""), file = reportRMD , sep = "\n", append = TRUE)
      cat(paste0("```{r message=FALSE, warning=FALSE, include=TRUE, echo = TRUE}"), file = reportRMD , sep = "\n", append = TRUE)
cat(paste0(""), file = reportRMD , sep = "\n", append = TRUE)
...
cat(paste0("ds <- HighFrequencyChecks::sample_dataset"), file = reportRMD , sep = "\n", append = TRUE)
...
cat(paste0(""), file = reportRMD , sep = "\n", append = TRUE)
                    cat(paste0("```{r eval=TRUE, echo=TRUE, message=FALSE, warning=FALSE, results='asis'}"), file = reportRMD , sep = "\n", append = TRUE)
cat(paste0(""), file = reportRMD , sep = "\n", append = TRUE)
...
cat(paste0("} "), file = reportRMD , sep = "\n", append = TRUE)
                                                                    cat(paste0("```"), file = reportRMD , sep = "\n", append = TRUE)
cat(paste0(""), file = reportRMD , sep = "\n", append = TRUE)
                                                                    cat(paste0("```{r eval=FALSE, echo=TRUE, results='asis'}"), file = reportRMD , sep = "\n", append = TRUE)
