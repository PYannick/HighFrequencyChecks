---
title: "High Frequency Checks: Example of a graphical template"
...
vignette: >
  ...
  %\VignetteIndexEntry{High Frequency Checks: Example of a graphical template}
...
```{r exportResultsInCSV, eval=FALSE, echo=FALSE, results='asis'}
#################################################################
## Not run during package creation, set eval=TRUE in real life ##
#################################################################
