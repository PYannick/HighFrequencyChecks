...
```{r display summaryParameters, eval=TRUE, echo=FALSE, results='asis', fig.align='center', fig.width=10, fig.height=8}
...
kable(data.frame(Values=questionsSurveySmallValues), caption = "Questions with values under will be reported for further checking")
kable(data.frame(Values=questionsSurveyBigValues), caption = "Questions with values above will be reported for further checking")
kable(data.frame(minimumAnswers=questionsEnumeratorIsLazy), caption = "Questions with an expected minimum number of answers")
```
...
for(i in ls(all.names = T)[ls(all.names = T) %like% "graphi"]){
  eval(parse(text=paste0(i, " <- ", i, " + ggplot2::theme(plot.title=ggplot2::element_text(size=10), plot.subtitle=ggplot2::element_text(size=8, colour = ' red'))")))
}
...
```{r display grapha, eval=FALSE, echo=FALSE, results='asis', fig.align='center', fig.width=10, fig.height=8}
...
```{r display graphassessmentProductivity, eval=TRUE, echo=FALSE, results='asis', fig.align='center', fig.width=10, fig.height=8}
print(graphassessmentProductivity + ggplot2::labs(title="graphassessmentProductivity"))
```

```{r display graphassessmentDailyValidSurveys, eval=TRUE, echo=FALSE, results='asis', fig.align='center', fig.width=10, fig.height=8}
print(graphassessmentDailyValidSurveys + ggplot2::labs(title="graphassessmentDailyValidSurveys"))
```

```{r display graphassessmentDurationOutliers, eval=TRUE, echo=FALSE, results='asis', fig.align='center', fig.width=10, fig.height=1.5}
print(graphassessmentDurationOutliers + ggplot2::labs(title="graphassessmentDurationOutliers"))
```

```{r display graphassessmentTrackingSheet, eval=TRUE, echo=FALSE, results='asis', fig.align='center', fig.width=10, fig.height=8}
print(graphassessmentTrackingSheet + ggplot2::labs(title="graphassessmentTrackingSheet"))
...
```{r display graphs, eval=FALSE, echo=FALSE, results='asis', fig.align='center', fig.width=10, fig.height=10}
for(i in ls(all.names = T)[ls(all.names = T) %like% "graphs"]){
  if(!is.null(get(i))){
    print(get(i))
  }
}
...
```{r display graphe, eval=TRUE, echo=FALSE, results='asis', fig.align='center', fig.width=10, fig.height=10}
for(i in ls(all.names = T)[ls(all.names = T) %like% "graphe"]){
  if(!is.null(get(i)) & i != "graphenumeratorErrorsDashboard"){
    print(get(i) + ggplot2::labs(title=i))
  }
}
```
...
cat("All the reports have been exported in .csv for further analysis or to prepare the cleaning log")
```
