...
```{r eval=TRUE, echo=TRUE, results='asis'}
list[dts_missing_id,err_missing_id] <- chk2a_missing_id(sample_dataset, 
                                                     uuid, 
                                                     consent, 
                                                     reportcol, 
                                                     TRUE)
sample_dataset <- dts_missing_id

if(nrow(err_missing_id)>0){ 
DT::datatable(err_missing_id, 
...
```{r eval=TRUE, echo=TRUE, results='asis'}
chk7aii_productivity_hist(sample_dataset, 
                                 surveydte, 
                                 dteformat, 
                                 consent)
