...
list_unique_id <- HighFrequencyChecks::isUniqueIDDuplicated(ds, UniqueID, survey_consent, reportingcol, delete)
ds <- list_unique_id[[1]]
...
```{r eval=TRUE, echo=TRUE, results='asis'}
list_missing_id <- HighFrequencyChecks::isUniqueIDMissing(ds, UniqueID, survey_consent, reportingcol, delete)
